...
export default function NoteDetailsPage() {
  ...
  return (
    <div>
      {/* <h3 className="text-2xl font-bold">{atividade.nome}</h3>
      <p className="py-6">Telefone: {atividade.telefone}</p>
      <p className="py-6">E-mail: {atividade.email}</p>
      <p className="py-6">CPF/CNPJ: {atividade.cpf_cnpj}</p> */}
