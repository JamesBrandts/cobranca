      ...
      <div>
        ...
        <div className="flex gap-2 items-center">
          ...
          <Form action="./parcial" method="post">
            <button
              type="submit"
              className={`rounded bg-yellow-500 px-4 py-2 text-white hover:bg-yellow-600 focus:bg-yellow-400 ${cobranca.status === "Parcialmente Convertida"&&"border-8 border-zinc-500"}`}
            >
          ...
          <Form action="./convertida" method="post">
            <button
              type="submit"
              className={`rounded bg-green-500 px-4 py-2 text-white hover:bg-green-600 focus:bg-green-400 ${cobranca.status === "Convertida"&&"border-8 border-zinc-500"}`}
            >
              Convertida
            </button>
          </Form>
          <Form action="./paga" method="post">
            <button
              type="submit"
              className={`rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600 focus:bg-blue-400 ${cobranca.status === "Paga"&&"border-8 border-zinc-500"}`}
            >
              Paga
            </button>
          </Form>
